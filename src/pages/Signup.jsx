...
const Signup = ({ onSignInClick, onHomeClick, onExploreClick, onMyOrdersClick, onAccountClick }) => {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-[#F5F7FA] font-inter">
            ...
            <div className="flex flex-col md:flex-row flex-grow">
                {/* Left Side - Image with Orange Overlay (Reused from Login) */}
                ...
                <div className="w-full md:w-1/2 flex flex-col items-center justify-center px-6 md:px-16 py-8 md:py-12 bg-[#F5F7FA]">
                    <div className="w-full max-w-md rounded-2xl">
                        ...
                        <form className="space-y-4">
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="block w-full pl-12 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-chuks-orange focus:border-chuks-orange transition-colors"
                                    />
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            placeholder="QWE123#"
                                            className="block w-full pl-12 pr-10 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-chuks-orange focus:border-chuks-orange transition-colors"
                                        />
                                        <button
                                            type="button"
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            placeholder="QWE123#"
                                            className="block w-full pl-12 pr-10 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-chuks-orange focus:border-chuks-orange transition-colors text-blue-600"
                                        />
                                        <button
                                            type="button"
                            ...
                            <div className="flex items-center">
                                <input
                                    type="checkbox"
                                    id="terms"
                                    className="h-4 w-4 text-chuks-orange focus:ring-chuks-orange border-gray-300 rounded"
                                />
                            ...
                            <button
                                ...
                                className="w-full py-3 bg-chuks-orange text-white rounded-xl font-semibold text-lg hover:bg-orange-600 transition-colors shadow-lg shadow-orange-200"
                            >
                                Continue
                            </button>
                            ...
                            <div className="space-y-3">
                                <button
                                    type="button"
                                    className="w-full flex items-center justify-center py-3 px-4 border border-gray-200 rounded-xl bg-white hover:bg-gray-50 transition-colors text-sm font-medium text-gray-700"
                                >
                        ...
                        <div className="mt-6 text-center text-xs text-gray-500">
                            Already have an account? <button onClick={onSignInClick} className="text-blue-500 hover:underline font-medium">Sign In</button>
                        </div>
                    </div>
                </div>
            </div>

            {/* Main Footer Section (Reused from Onboarding/Login) */}
            <Footer
